...
public class TaskService {
    ...
    public Task assignCleaningTask(Long locationId, Task task) {
        // Find all employees assigned as cleaners in the location
    	Long cleanerId = taskRepository.findCleanerWithLeastTasks();
        if (cleanerId == null) {
            throw new RuntimeException("No available cleaners.");
        }

        // Assign the task
        task.setAssignedEmployeeId(cleanerId);
