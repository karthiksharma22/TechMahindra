...
public class TaskController {
    ...
    @PostMapping("/assign-auto-task/{locationId}/{role}")
    public ResponseEntity<Task> assignAutoTask(
        @PathVariable Long locationId,
        @PathVariable String role, // Accept role dynamically
        @RequestBody Task task) {  

        Task assignedTask = taskService.assignAutoTask(locationId, role, task);
